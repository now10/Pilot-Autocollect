...
import { mockBankAccounts } from '@/data/mock';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { Label } from '@/components/ui/label';
import { Badge } from '@/components/ui/badge';
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger } from '@/components/ui/dialog';
import { Plus, Building2, Star, Shield, Trash2 } from 'lucide-react';
...
const BankAccountsPage = () => {
  ...
  const handleAdd = () => {
    toast.success('IBAN added (mock)', { description: 'Micro-deposit verification would begin in production.' });
  };
        ...
        <Dialog>
          ...
          <DialogContent className="glass-card border-border">
            ...
            <form className="space-y-4" onSubmit={e => { e.preventDefault(); handleAdd(); }}>
              <div className="space-y-2"><Label>Bank Name</Label><Input placeholder="Wise, Revolut, N26..." className="bg-muted border-border" /></div>
              <div className="space-y-2"><Label>IBAN</Label><Input placeholder="DE89 3704 0044 ..." className="bg-muted border-border font-mono text-sm" /></div>
              ...
              <Button className="w-full">Add & Verify IBAN</Button>
            </form>
          </DialogContent>
        </Dialog>
      </div>
